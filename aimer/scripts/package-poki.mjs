 ...
 * repo root, because the same three mistakes end a submission for every game
 * in this monorepo and a second copy of the rules is a copy that drifts. What
 * is left here is the part that is actually about packaging: the archive, with
 * `index.html` at its root, which is where Poki looks for it.
 *
