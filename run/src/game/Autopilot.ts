 ...
 */
/**
 * Decides what one robot should do this frame. Shared by two callers: the
 * headless verification bot, which drives both and proves every level is
 * beatable, and the in-game autopilot, which takes over a robot nobody is
 * playing so one person can run the pair.
 */
export class Autopilot {
  private drives: Drive[] = [newDrive(), newDrive()];

  /** Set by the verification bot to collect a decision log. */
