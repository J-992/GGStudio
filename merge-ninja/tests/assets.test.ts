...
const ARENA_PATHS: Readonly<Record<string, string>> = {
  dojo_night_backdrop: 'assets/dojo-night-backdrop.png',
  arena_mountain: 'assets/arena-mountain.png',
  arena_storm: 'assets/arena-storm.png',
  arena_rift_stage: 'assets/arena-rift-stage.png',
  arena_shrine: 'assets/arena-shrine.png',
  floor_dojo: 'assets/floor-dojo.png',
  floor_temple: 'assets/floor-temple.png',
  floor_storm: 'assets/floor-storm.png',
  floor_rift: 'assets/floor-rift.png',
  floor_shrine: 'assets/floor-shrine.png',
};
...
describe('shipping asset manifest', () => {
  it('contains every statically configured runtime file and none are empty', () => {
    const files = new Set<string>([
      ...
      'assets/font.png',
      'assets/font.xml',
      'assets/arena-cloud-bank.png',
      'assets/dojo-roster-deck.png',
      'assets/tex/tex_0.png',
      'assets/tex/tex_1.png',
      'assets/tex/tex_2.png',
      'assets/tex/tex_3.png',
      'assets/tex/tex_4.png',
      'assets/tex/tex_5.png',
      'assets/tex/tex_industrial.png',
      ACHIEVEMENTS_ICON_PATH,
