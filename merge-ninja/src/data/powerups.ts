...
export const POWERUPS: Readonly<Record<PowerupId, PowerupDef>> = {
  shurikenFrenzy: {
    ...
    iconPath: 'assets/powerups/shuriken-frenzy.png',
  ...
  smokeBomb: {
    ...
    iconPath: 'assets/powerups/smoke-bomb.png',
  ...
  luckyCharm: {
    ...
    iconPath: 'assets/powerups/lucky-charm.png',
  ...
  protectiveWard: {
    ...
    iconPath: 'assets/powerups/protective-ward.png',
    effect: 'ward',
    charges: 3,
  ...
  coinFrenzy: {
    ...
    iconPath: 'assets/powerups/coin-frenzy.png',
    effect: 'coinRain',
    coinCount: 36,
