...
const motionPortrait = (
  ...
  return portrait(
    ...
    `assets/ninja-motion-t${suffix}.png`,
    footInset,
    animation,
    sourceTextureKey,
  );
...
export const NINJA_CATALOG_PORTRAITS: readonly CatalogPortrait[] = [
  ...
  portrait(FLAME_SHOGUN_TIER, 'flame_shogun', 'assets/samurai-ready.png', CATALOG_FOOT_INSET, FOUR_FRAME_128, 'flame_shogun'),
...
const bossMotionPortrait = (
  ...
  return portrait(
    ...
    `assets/boss-motion-a${suffix}.png`,
    8,
    EIGHT_FRAME_256,
    sourceTextureKey,
  );
...
export const BOSS_CATALOG_PORTRAITS: readonly CatalogPortrait[] = [
  portrait(1, 'boss_catalog_26', 'assets/boss-catalog-26.png'),
  portrait(2, 'boss_catalog_39', 'assets/boss-catalog-39.png'),
  portrait(3, 'boss_catalog_25', 'assets/boss-catalog-25.png'),
  portrait(4, 'ninja_catalog_28', 'assets/ninja-catalog-28.png'),
  portrait(5, 'boss_catalog_31', 'assets/boss-catalog-31.png'),
  portrait(6, 'ninja_catalog_30', 'assets/ninja-catalog-30.png'),
  portrait(7, 'ninja_catalog_31', 'assets/ninja-catalog-31.png'),
  portrait(8, 'boss_catalog_33', 'assets/boss-catalog-33.png'),
  portrait(9, 'ninja_catalog_35', 'assets/ninja-catalog-35.png'),
  portrait(10, 'boss_catalog_34', 'assets/boss-catalog-34.png'),
  portrait(11, 'boss_catalog_38', 'assets/boss-catalog-38.png'),
  portrait(12, 'boss_catalog_35', 'assets/boss-catalog-35.png'),
  portrait(13, 'boss_catalog_28', 'assets/boss-catalog-28.png'),
  portrait(14, 'ninja_catalog_32', 'assets/ninja-catalog-32.png'),
  portrait(15, 'ninja_catalog_33', 'assets/ninja-catalog-33.png'),
  portrait(16, 'ninja_catalog_34', 'assets/ninja-catalog-34.png'),
  portrait(17, 'boss_catalog_32', 'assets/boss-catalog-32.png'),
  portrait(18, 'ninja_catalog_29', 'assets/ninja-catalog-29.png'),
  portrait(19, 'boss_catalog_37', 'assets/boss-catalog-37.png'),
  portrait(20, 'boss_catalog_27', 'assets/boss-catalog-27.png'),
  portrait(21, 'boss_catalog_36', 'assets/boss-catalog-36.png'),
  bossMotionPortrait(22, 'ninja_catalog_37'),
  bossMotionPortrait(23, 'ninja_catalog_36'),
  bossMotionPortrait(24, 'ninja_catalog_38'),
  portrait(25, 'ninja_catalog_39', 'assets/ninja-catalog-39.png'),
