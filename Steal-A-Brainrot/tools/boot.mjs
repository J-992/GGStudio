...
export async function boot(scripts) {
  ...
  try {
    data = runInContext('({ CFG, CREATURES, CREATURES_BY_ID, RARITIES, ENEMIES, BOSSES, LEVELS, LAYOUT, configureLayout, Poki, SaveSys, AudioSys, Units, TextureFactory })', context);
  } catch (err) {
