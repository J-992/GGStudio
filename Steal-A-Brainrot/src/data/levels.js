...
//
// `prepMs`, `waveGapMs` and `clearGapMs` override CFG.LEVEL for this level
// only -- the early levels get a longer look at an empty lawn, a longer gap
// between waves, and a much longer breather after clearing one. That is the
// cheapest difficulty dial there is and the one that does not make the game
// feel easier once you are good at it.
//
// clearGapMs is the one players feel most: it is the pause after the lawn goes
// quiet, and it is the only time you get to spend banked coins on another
// plant. Too short and the whole level is fought with the squad you could
// afford at wave 1.
//
...
const LEVELS = [
  { level: 1, name: 'THE FRONT LAWN', lanes: [2, 3], startEnergy: 125, reward: 150,
    prepMs: 15000, waveGapMs: 38000, clearGapMs: 13000,
    waves: [
  ...
  { level: 2, name: 'GARDEN GATE', lanes: [2, 3, 4], startEnergy: 125, reward: 180,
    prepMs: 14000, waveGapMs: 38000, clearGapMs: 13000,
    waves: [
  ...
  { level: 3, name: 'SIDE STREET', lanes: [1, 2, 3, 4], startEnergy: 100, reward: 220,
    prepMs: 12000, waveGapMs: 36000, clearGapMs: 11000,
    waves: [
  ...
  { level: 4, name: 'PIAZZA PANIC', lanes: [0, 1, 2, 3, 4], startEnergy: 100, reward: 280,
    prepMs: 10000, waveGapMs: 35000, clearGapMs: 10000,
    waves: [
  ...
  { level: 5, name: 'GELATO ALLEY', lanes: [0, 1, 2, 3, 4, 5], startEnergy: 100, reward: 340,
    prepMs: 10000, waveGapMs: 34000, clearGapMs: 9000,
    waves: [
