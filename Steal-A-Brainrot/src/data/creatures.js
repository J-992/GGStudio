...
const CREATURES = [
  ...
  { id: 'octopussini', name: 'Blueberrinni Octopussini', rarity: 'common', price: 32, income: 5,
    art: 'graipuss',   color: 0x7e57c2, accent: 0xb39ddb },
  { id: 'burbaloni',   name: 'Burbaloni Luliloli',     rarity: 'common', price: 42, income: 6,
    art: 'burbaloni',  color: 0x8d6e63, accent: 0xd7ccc8 },

  // -------- uncommon --------
  { id: 'orangutini',  name: 'Orangutini Ananasini',   rarity: 'uncommon', price: 95, income: 9,
    art: 'chimpanzini', color: 0xffd54f, accent: 0xa1887f },
  { id: 'bobritto',    name: 'Bobrito Bandito',        rarity: 'uncommon', price: 140, income: 12,
    art: 'bobritto',   color: 0x6d4c41, accent: 0xfafafa },
  { id: 'trulimero',   name: 'Trulimero Trulicina',    rarity: 'uncommon', price: 185, income: 15,
    art: 'trippi',     color: 0xffa726, accent: 0xffcc80 },
  { id: 'cocofanto',   name: 'Cocofanto Elefanto',     rarity: 'uncommon', price: 240, income: 19,
    art: 'lirili',     color: 0xa1887f, accent: 0x8d6e63 },

  // -------- rare --------
  { id: 'patapim',     name: 'Brr Brr Patapim',        rarity: 'rare', price: 480,  income: 34,
    art: 'patapim',    color: 0x8d6e63, accent: 0x66bb6a },
  { id: 'assassino',   name: 'Cappuccino Assassino',   rarity: 'rare', price: 620,  income: 42,
    art: 'assassino',  color: 0xfafafa, accent: 0xd32f2f },
  { id: 'lirili',      name: 'Lirilì Larilà',          rarity: 'rare', price: 800, income: 52,
    art: 'lirili',     color: 0x66bb6a, accent: 0x9e9e9e },
  { id: 'girafa',      name: 'Girafa Celestre',        rarity: 'rare', price: 1050, income: 66,
    art: 'glorbo',     color: 0x43a047, accent: 0xe53935 },

  // -------- epic --------
  { id: 'chimpanzini', name: 'Chimpanzini Bananini',   rarity: 'epic', price: 2300, income: 130,
    art: 'chimpanzini', color: 0xffe135, accent: 0x5d4037 },
  { id: 'ballerina',   name: 'Ballerina Cappuccina',   rarity: 'epic', price: 3200, income: 175,
    art: 'ballerina',  color: 0xfafafa, accent: 0xf06292 },
  { id: 'udin',        name: 'Udin Din Din Dun',       rarity: 'epic', price: 4300, income: 230,
    art: 'assassino',  color: 0xffb300, accent: 0x4e342e },

  // -------- legendary --------
  { id: 'tungtung',    name: 'Tung Tung Tung Sahur',   rarity: 'legendary', price: 8200, income: 420,
    art: 'tungtung',   color: 0xa1887f, accent: 0x5d4037 },
  { id: 'bombardiro',  name: 'Bombardiro Crocodilo',   rarity: 'legendary', price: 11000, income: 560,
    art: 'bombardiro', color: 0x558b2f, accent: 0x78909c },

  // -------- mythic --------
  { id: 'tralalero',   name: 'Tralalero Tralala',      rarity: 'mythic', price: 26000, income: 1300,
    art: 'tralalero',  color: 0x5c9ec7, accent: 0x1565c0 },

  // -------- secret --------
  { id: 'vacca',       name: 'La Vacca Saturno Saturnita', rarity: 'secret', price: 62000, income: 3200,
...
// What two of `id` fuse into: the next entry in the catalogue, which is
// ordered by rarity then price, so a merge always steps up. The last creature
// has nothing above it and so never merges.
const MERGE_INTO = {};
CREATURES.forEach((c, i) => { MERGE_INTO[c.id] = CREATURES[i + 1] || null; });

window.RARITIES = RARITIES;
window.CREATURES = CREATURES;
window.CREATURES_BY_ID = CREATURES_BY_ID;
window.MERGE_INTO = MERGE_INTO;
